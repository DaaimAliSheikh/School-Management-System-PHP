...
///removed hardcoded condition for student= && $_POST['type'] == 'student' and !empty($_POST['email']) was twice, so replaced one with  'name'
//also added one for password
if(isset($_POST['type'])  && isset($_POST['email']) && isset($_POST['password']) && !empty($_POST['name']))
{
    ...
    $password = isset($_POST['password'])?$_POST['password']:'abc';  ///custom password
