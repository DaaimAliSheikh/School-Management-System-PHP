...
if (empty($patchData['serial']) || empty($patchData['title']) || empty($patchData['sections'])  ) {
...
$sections = mysqli_real_escape_string($db_conn, $patchData['sections']);
$added_date = mysqli_real_escape_string($db_conn, $patchData['added_date']);

// Update the `accounts` table
$updateQuery = "UPDATE `classes` SET `title` = '$title',`section` = '$sections', `added_date` = '$added_date' WHERE `id` = '$id'";
