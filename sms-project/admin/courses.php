...
<?php include('sidebar.php') ?>
  ...
  jQuery(document).ready(function(){
    ...
    jQuery('#courses-table').on('click', '.delete-row', function (e) {
        e.preventDefault();
        ...
        jQuery.ajax({
            url: '../actions/delete-course-row.php', // Update this to your delete endpoint
            type: 'DELETE',
            data: { serial: rowId },
  ...
  jQuery('#course-registration').on('submit', function(e) {
    e.preventDefault(); // Prevent form submission

      let formData = new FormData(this); // Create FormData object
      console.log(formData);
      $.ajax({
          url: '../actions/course-registration.php', // Backend PHP script
          type: 'POST',
          data: formData,
          contentType: false,
          processData: false,
          complete: function (response) {
              location.href = "http://localhost/sms-project/admin/courses.php";
          },
